...
from broker import ElasticSearchBroker
...
def run(core_dir, nlu_dir):
    ...
    _tracker_store = InMemoryTrackerStore(None, event_broker=ElasticSearchBroker(os.getenv('ELASTICSEARCH_URL', 'elasticsearch:9200')))
